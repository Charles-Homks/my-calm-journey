...
const values = [
  {
    icon: Lock,
    title: "Privacy-First",
    description: "Your data belongs to you. We never sell your information and always give you control over what you share.",
  },
  {
    icon: Shield,
    title: "Safety-First",
    description: "We design with care, always including clear guidance and resources for professional support when needed.",
  },
  {
    icon: Heart,
    title: "Compassion-Led",
    description: "Every feature is built with empathy, understanding that wellbeing is personal and everyone's journey is unique.",
  },
  {
    icon: Sparkles,
    title: "Science-Informed",
    description: "Our routines are grounded in evidence-based wellbeing practices, adapted for everyday life.",
  },
];
        ...
        <div className="container-wide">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Calmnest was born from a simple belief: everyone deserves accessible tools to support their daily wellbeing.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Calmnest combines thoughtful design with AI personalisation to help you build routines that actually stick—without the pressure of perfection.
                </p>
              </div>
      ...
      <section className="section-padding bg-cream-dark">
        <div className="container-wide">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
              Mental health awareness has never been higher, yet practical, accessible tools remain out of reach for many. Traditional approaches often require significant time, money, or professional access.
            </p>
            <p className="text-lg text-muted-foreground leading-relaxed">
      ...
      <section className="section-padding bg-background">
        <div className="container-wide">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="card-calm shadow-card max-w-md mx-auto text-center">
              <div className="w-24 h-24 rounded-full bg-sage-light flex items-center justify-center mx-auto mb-4">
                <Users className="w-12 h-12 text-primary" />
              </div>
              <h3 className="text-xl font-semibold text-foreground mb-1">Founder</h3>
              <p className="text-muted-foreground mb-4">Founder & CEO</p>
              <p className="text-sm text-muted-foreground leading-relaxed">
                Passionate about making wellbeing support accessible to everyone. Building Calmnest to bridge the gap between self-care and professional support.
              </p>
            </div>
          </div>
        </div>
